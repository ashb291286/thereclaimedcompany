...
export async function POST(req: Request) {
  ...
  } else if (folder === "individual-profile") {
    objectPath = `sellers/${session.user.id}/profile-${stamp}-${safeName}`;
  } else if (folder === "individual-header") {
    objectPath = `sellers/${session.user.id}/header-${stamp}-${safeName}`;
  ...
  } else if (folder === "dealer-provenance") {
    objectPath = `dealer-provenance/${session.user.id}/${stamp}-${safeName}`;
  } else if (folder === "dealer-deal-message") {
    objectPath = `dealer-deal/${session.user.id}/${stamp}-${safeName}`;
  } else {
